describe("Table header loads", () => {
  ...
  it("It sorts by name", () => {
    ...
    cy.get("tbody").find('tr td').eq(1).invoke('text').should('match', /^3rd generation/);
    cy.get("#table-header-name").click();
    cy.get("tbody").find('tr td').eq(1).invoke('text').should('match', /^workforce/);
  });
  ...
  it("It sorts by created by", () => {
    ...
    cy.get("tbody").find('tr td').eq(2).invoke('text').should('match', /^Brandi/);
    cy.get("#table-header-createdBy").click();
    cy.get("tbody").find('tr td').eq(2).invoke('text').should('match', /^Aleta/);
    cy.get("#table-header-createdBy").click();
    cy.get("tbody").find('tr td').eq(2).invoke('text').should('match', /^Zelda/);
  });
  ...
  it("Loads parametres from url", () => {
    ...
    cy.get("tbody").find('tr td').eq(1).invoke('text').should('match', /^coherent/);
