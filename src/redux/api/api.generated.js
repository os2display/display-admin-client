...
exports.api = (0, react_1.createApi)({
    ...
    endpoints: function (build) { return ({
        ...
        getV1ExternalUsersById: build.query({
            query: function (queryArg) { return ({ url: "/v1/external-users/" + queryArg.id }); }
        }),
